...
namespace xpTURN.AssetLink.Editor
{
    ...
    /// </summary>
    public class SpriteAtlasPopupForRef : EditorWindow
    {
        ...
        public static SpriteAtlasPopupForRef Show(SpriteAtlas atlas, AssetRef assetRef, Object targetObject, SerializedProperty property)
        {
            var window = CreateInstance<SpriteAtlasPopupForRef>();
            window.Initialize(atlas, assetRef, targetObject, property);
        ...
        private void Initialize(SpriteAtlas atlas, AssetRef assetRef, Object targetObject, SerializedProperty property)
        {
            m_assetRef = assetRef;
        ...
        private void OnGUI()
        {
            ...
            else
            {
                ...
                {
                    bool isSelected = m_assetRef.SubObjectName == info.name;
        ...
        private void SelectSprite(SpriteInfo info)
        {
            ...
            m_assetRef.SetAssetGUID(m_assetRef.AssetGUID, info.name);
